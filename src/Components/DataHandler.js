...
const DataHandler = props => {
    ...
    useEffect(() => {
        const apiCall = async () => {
            const url = `https://data.cityofnewyork.us/resource/qgea-i56i.json?$where=cmplnt_fr_dt%20between%20%27${year}-01-01T00:00:00%27%20and%20%27${year}-12-31T23:59:00%27`
